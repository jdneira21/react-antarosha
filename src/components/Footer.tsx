      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap pt-6 text-center lg:text-left">
          <div className="w-full px-4 lg:w-6/12">
            <h4 className="block antialiased tracking-normal font-open-sans text-2xl font-semibold leading-snug text-blue-gray-900 mb-4">Antarosha</h4>
            <p className="block antialiased font-open-sans text-base leading-relaxed font-normal text-blue-gray-500">2023</p>
          ...
          <div className="mx-auto mt-12 grid w-max grid-cols-2 gap-24 lg:mt-0">
            <div>
              ...
              <ul className="mt-3">
                <li>
                  <a href="" target="_blank" rel="noreferrer" className="antialiased font-open-sans text-sm leading-normal mb-2 block font-normal text-blue-gray-500 hover:text-blue-gray-700">Link</a>
                </li>
                <li>
                  <a href="" target="_blank" rel="noreferrer" className="antialiased font-open-sans text-sm leading-normal mb-2 block font-normal text-blue-gray-500 hover:text-blue-gray-700">Link</a>
                </li>
